  ...
  return (
    <div className='p-8 h-lvh '>
        ...
        <div className='flex flex-col justify-center text-center items-center h-5/6 w-1/2 m-auto'>
            <h2 className='text-white text-2xl'>When Innovation Meets <span className='text-cyan-dark bg-cyan-300 border-none rounded-xl pl-1 pr-1 mt-1'>Investment</span></h2>
