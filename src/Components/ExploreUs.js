...
export default function ExploreUs() {
  return (
    <div className='border-1 border-cyan-700 bg-transparent shadow-inner shadow-cyan-400 rounded-md p-3 lg:p-6 m-3 mb-14 flex flex-col justify-center items-center text-center lg:w-4/6 lg:m-auto lg:mb-14'>
      <h2 className='text-white text-2xl mb-6 mt-4'>Explore Our <span className='text-cyan-400'>dApp</span></h2>
