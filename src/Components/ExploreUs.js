...
export default function ExploreUs() {
  return (
    <div className='border-1 border-cyan-700 bg-transparent shadow-inner shadow-cyan-400 rounded-md p-3 m-3 mb-14 flex flex-col justify-center items-center text-center'>
