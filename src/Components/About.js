...
export default function About() {
  return (
    <div className='p-8'>
      <div className='text-center lg:w-2/3 lg:m-auto'>
        <h1 className='text-white text-2xl pb-2 text-center font-medium lg:text-3xl'>About EthAi</h1>
      ...
      <div className='bg-cyan-light border-1 border-cyan-deep-light rounded-lg p-3 mt-8 lg:flex lg:flex-row lg:flex-wrap lg:w-2/3 lg:m-auto lg:mt-10 lg:pl-10'>
        ...
        <div className='mt-8  lg:w-1/2 mb-8'>
